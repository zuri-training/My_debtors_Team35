...
function FeatureSection(props) {
    return (
        ...
        <div className="surface-0 text-center px-4 md:px-8 my-8">
             <section>
                    <h3 className="text-4xl font-bold mb-3">Why use stuDEBT</h3>
                    <p className="mt-0 mb-4 text-700 line-height-3">We offer interesting features that will help in keeping track of students pending payment records which can be accessible in one place.</p>
                </section>
            <div className="grid">
