    ...
    <section className="container sm:px-5">
      <div className="grid">
        <nav className="col-12 flex sm:justify-content-between align-items-center my-5">
          <Link href="/student">
            <i className="pi pi-arrow-left sm:hidden subheading cursor-pointer"></i>
          </Link>
          <h5 className="subheading md:text-xl text-lg sm:mx-0 mx-auto">
            Notifications
          </h5>
          <Link href="/student">
            <h6 className="subheading lg:text-sm text-xs sm:inline-block hidden cursor-pointer">
              Back to Profile
            </h6>
          </Link>
        </nav>
        <main className="col-12 flex flex-column gap-3 relative">
